...
exports.handler = async (event) => {
  ...
  // TODO: Read and parse "limit" and "nextKey" parameters from query parameters
     let nextKey = event.queryStringParameters.nextKey // Next key to continue scan operation if necessary
     let limit = event.queryStringParameters.limit// Maximum number of elements to return
